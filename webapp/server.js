...
- Header/Footer achtergrond: gradient linear-gradient(135deg, #FF8514, #FF4D00), witte tekst
- Header bevat rechts altijd een "← Bibliotheek" link (wit, half-transparante pill-knop)
- .header-back: background rgba(255,255,255,0.2), color white, border-radius 50px, padding 6px 14px
